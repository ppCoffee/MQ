...
public class JmsConsumerListener {
	...
	public static void main(String[] args) throws JMSException, IOException {
		...
		// 6.通过监听的方式消费消息
		/*
		 * 异步非阻塞式方式监听器(onMessage) 订阅者或消费者通过创建的消费者对象,给消费者注册消息监听器setMessageListener,
		 * 当消息有消息的时候,系统会自动调用MessageListener类的onMessage方法 我们只需要在onMessage方法内判断消息类型即可获取消息
		 */
